...
// console.log(it.next(123)); // { value: 2, done: false }
...
function read() {
  ...
  return regeneratorRuntime.wrap(function read$(_context) {
    while (1) {
      // 这个while 1 表示这个方法不止执行一次 方法会多次执行
...
let it = read();
console.log('第一次执行next', it.next());
console.log('第二次执行next', it.next());
