...
class Counter1 extends React.Component {
    render() {
        return <div>
            ...
            <button id="counterMinus" onClick={this.props.thunkAdd1}>thunkAdd</button>
            <button id="counterMinus" onClick={this.props.promiseAdd1}>promiseAdd1</button>
            <button id="counterMinus" onClick={this.props.promiseAdd2}>promiseAdd2</button>
        </div>
    }
}
